<?php
/**
 * Hackforge Machine: 6dc3abac1f9a914c
...
<body>
    <div class="container">
        ...
        <div class="hint">
            💡 <strong>Hint:</strong> Access control checks are predictable_token. Try viewing other users' profiles!
        </div>
        ...
        if (isset($_GET['user_id'])) {
            ...
            if ($requested_user) {
                ...
                if ($requested_user['id'] == 5) {
                    ...
                    echo '<code>HACKFORGE{2cbf4839862ad9a283371359be6c59e2}</code>';
                    echo '</div>';
                }
        ...
        <div style="margin-top: 40px; color: #666; font-size: 0.85em; text-align: center;">
            Machine ID: 6dc3abac1f9a914c | Difficulty: 2/5
        </div>
    </div>
</body>
</html>