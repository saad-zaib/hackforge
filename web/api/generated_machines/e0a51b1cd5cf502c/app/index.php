<?php
/**
 * Hackforge Machine: e0a51b1cd5cf502c
...
<body>
    <div class="container">
        <h1>🗄️ SEARCH FUNCTION</h1>
        
        <div class="info-box">
            <strong>Machine ID:</strong> <code>e0a51b1cd5cf502c</code><br>
            <strong>Database:</strong> mongodb<br>
            <strong>Parameter:</strong> <code>search</code>
        </div>
