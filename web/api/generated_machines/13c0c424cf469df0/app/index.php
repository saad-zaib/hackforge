<?php
/**
 * Hackforge Machine: 13c0c424cf469df0
...
<head>
    ...
    <script>
        function fillExample(cmd) {
            document.getElementById('domain').value = cmd;
        }
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            <strong>Machine ID:</strong> <code>13c0c424cf469df0</code><br>
            <strong>Difficulty:</strong> 2/5<br>
            <strong>Parameter:</strong> <code>domain</code>
        </div>
        ...
        <form method="GET">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?php echo htmlspecialchars($_GET['domain'] ?? ''); ?>"
                       autofocus>
            </div>
