<?php
/**
 * Hackforge Machine: ffb4bbd15ac7a56c
...
<body>
    <div class="container">
        ...
        <div class="hint">
            💡 <strong>Hint:</strong> Access control checks are timing_vulnerable. Try viewing other users' profiles!
        </div>
        ...
        if (isset($_GET['user_id'])) {
            ...
            if ($requested_user) {
                ...
                if ($requested_user['id'] == 5) {
                    ...
                    echo '<code>HACKFORGE{beec54351c6950c2835d66835f2514e0}</code>';
                    echo '</div>';
                }
        ...
        <div style="margin-top: 40px; color: #666; font-size: 0.85em; text-align: center;">
            Machine ID: ffb4bbd15ac7a56c | Difficulty: 1/5
        </div>
    </div>
</body>
</html>