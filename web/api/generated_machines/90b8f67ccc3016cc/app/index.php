<?php
/**
 * Hackforge Machine: 90b8f67ccc3016cc
...
<body>
    <div class="container">
        ...
        <div class="hint">
            💡 <strong>Hint:</strong> Access control checks are weak_session_check. Try viewing other users' profiles!
        </div>
        ...
        if (isset($_GET['user_id'])) {
            ...
            if ($requested_user) {
                ...
                if ($requested_user['id'] == 5) {
                    echo '<div class="secret">';
                    echo '<strong>🚩 SECRET DATA (Admin Only):</strong><br><br>';
                    echo '<code>HACKFORGE{85acd837b3f3faaa8e6ab6a1fb594517}</code>';
                    echo '</div>';
                }
        ...
        <div style="margin-top: 40px; color: #666; font-size: 0.85em; text-align: center;">
            Machine ID: 90b8f67ccc3016cc | Difficulty: 3/5
        </div>
    </div>
</body>
</html>