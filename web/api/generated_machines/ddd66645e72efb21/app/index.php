<?php
/**
 * Hackforge Machine: ddd66645e72efb21
...
<head>
    ...
    <script>
        function fillExample(cmd) {
            document.getElementById('host').value = cmd;
        }
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            <strong>Machine ID:</strong> <code>ddd66645e72efb21</code><br>
            <strong>Difficulty:</strong> 1/5<br>
            <strong>Parameter:</strong> <code>host</code>
        </div>
        ...
        <form method="GET">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?php echo htmlspecialchars($_GET['host'] ?? ''); ?>"
                       autofocus>
            </div>
