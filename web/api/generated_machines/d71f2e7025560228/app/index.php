<?php
/**
 * Hackforge Machine: d71f2e7025560228
...
<head>
    ...
    <script>
        function fillExample(cmd) {
            document.getElementById('pattern').value = cmd;
        }
...
<body>
    <div class="container">
        ...
        <div class="info-box">
            <strong>Machine ID:</strong> <code>d71f2e7025560228</code><br>
            <strong>Difficulty:</strong> 2/5<br>
            <strong>Parameter:</strong> <code>pattern</code>
        </div>
        ...
        <form method="GET">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?php echo htmlspecialchars($_GET['pattern'] ?? ''); ?>"
                       autofocus>
            </div>
