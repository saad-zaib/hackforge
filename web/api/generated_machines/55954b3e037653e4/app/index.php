<?php
/**
 * Hackforge Machine: 55954b3e037653e4
...
<body>
    <div class="container">
        ...
        <div class="hint">
            💡 <strong>Hint:</strong> Access control checks are none. Try viewing other users' profiles!
        </div>
        ...
        if (isset($_GET['user_id'])) {
            ...
            if ($requested_user) {
                ...
                if ($requested_user['id'] == 5) {
                    ...
                    echo '<code>HACKFORGE{723e1b56a4d5b81f12672e2d39bbfd4d}</code>';
                    echo '</div>';
                }
        ...
        <div style="margin-top: 40px; color: #666; font-size: 0.85em; text-align: center;">
            Machine ID: 55954b3e037653e4 | Difficulty: 1/5
        </div>
    </div>
</body>
</html>