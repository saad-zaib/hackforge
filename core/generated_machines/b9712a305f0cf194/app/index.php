<?php
/**
 * Hackforge Machine: b9712a305f0cf194
...
<body>
    <div class="container">
        ...
        <p>Context: document_processor</p>
        ...
        <div class="hint">
            <strong>💡 Hint:</strong> This is a document_processor context. Can you find the vulnerability?
        </div>
    </div>
</body>
</html>