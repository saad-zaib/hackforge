"""
Insecure Direct Object Reference Vulnerability Templates
...
class IdorInjectionTemplate(BaseTemplate):
    """
    Template generator for insecure direct object reference vulnerabilities
    """
    ...
    def generate_code(self) -> str:
        ...
        if variant == "Basic IDOR":
            return self._generate_basic_idor()
        elif variant == "Mass Assignment IDOR":
            return self._generate_mass_assignment_idor()
        elif variant == "Function-level IDOR":
            return self._generate_function_level_idor()
        else:
            return self._generate_basic_idor()

    def _generate_basic_idor(self) -> str:
        """Generate Basic IDOR vulnerable application with themed UI"""
...
<html>
<head>
    <title>Basic IDOR Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_mass_assignment_idor(self) -> str:
        """Generate Mass Assignment IDOR vulnerable application with themed UI"""
...
<html>
<head>
    <title>Mass Assignment IDOR Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_function_level_idor(self) -> str:
        """Generate Function-level IDOR vulnerable application with themed UI"""
...
/**
 * Hackforge Machine: {self.machine_id}
 * Vulnerability: Function-level IDOR
 * Theme: {self.theme['name']}
 * Difficulty: {self.difficulty}/5
 */
?>
...
<html>
<head>
    <title>Function-level IDOR Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def generate_dockerfile(self) -> str:
        """Generate Dockerfile for insecure direct object reference vulnerabilities"""
