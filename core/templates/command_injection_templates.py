...
<body>
    ...
    def _generate_command_injection_with_filters(self) -> str:
        """Generate Command Injection with Filters vulnerable application with themed UI"""
...
/**
 * Hackforge Machine: {self.machine_id}
 * Vulnerability: Command Injection with Filters
 * Theme: {self.theme['name']}
 * Difficulty: {self.difficulty}/5
 */
...
<html>
<head>
    <title>Command Injection with Filters Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_advanced_command_injection(self) -> str:
        """Generate Advanced Command Injection vulnerable application with themed UI"""
...
/**
 * Hackforge Machine: {self.machine_id}
 * Vulnerability: Advanced Command Injection
 * Theme: {self.theme['name']}
 * Difficulty: {self.difficulty}/5
 */
...
<html>
<head>
    <title>Advanced Command Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    <div class="container">
        <h1>Advanced Command Injection</h1>
        <p>Context: {context}</p>
