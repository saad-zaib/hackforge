"""
NoSQL Injection Vulnerability Templates
...
class NosqlInjectionTemplate(BaseTemplate):
    """
    Template generator for nosql injection vulnerabilities
    """
    ...
    def generate_code(self) -> str:
        ...
        if variant == "MongoDB Injection":
            return self._generate_mongodb_injection()
        elif variant == "Authentication Bypass":
            return self._generate_authentication_bypass()
        elif variant == "Operator Injection":
            return self._generate_operator_injection()
        else:
            return self._generate_mongodb_injection()

    def _generate_mongodb_injection(self) -> str:
        """Generate MongoDB Injection vulnerable application with themed UI"""
...
<html>
<head>
    <title>MongoDB Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_authentication_bypass(self) -> str:
        """Generate Authentication Bypass vulnerable application with themed UI"""
...
<html>
<head>
    <title>Authentication Bypass Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_operator_injection(self) -> str:
        """Generate Operator Injection vulnerable application with themed UI"""
...
<html>
<head>
    <title>Operator Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def generate_dockerfile(self) -> str:
        """Generate Dockerfile for nosql injection vulnerabilities"""
