"""
Insecure Deserialization Vulnerability Templates
...
class SoftwareDataIntegrityFailuresTemplate(BaseTemplate):
    """
    Template generator for insecure deserialization vulnerabilities
    """
    ...
    def generate_code(self) -> str:
        ...
        if variant == "PHP Object Injection":
            return self._generate_php_object_injection()
        elif variant == "Java Deserialization":
            return self._generate_java_deserialization()
        elif variant == "Python Pickle Injection":
            return self._generate_python_pickle_injection()
        else:
            return self._generate_php_object_injection()

    def _generate_php_object_injection(self) -> str:
        """Generate PHP Object Injection vulnerable application with themed UI"""
...
<html>
<head>
    <title>PHP Object Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_java_deserialization(self) -> str:
        """Generate Java Deserialization vulnerable application with themed UI"""
...
<html>
<head>
    <title>Java Deserialization Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def _generate_python_pickle_injection(self) -> str:
        """Generate Python Pickle Injection vulnerable application with themed UI"""
...
/**
 * Hackforge Machine: {self.machine_id}
 * Vulnerability: Python Pickle Injection
 * Theme: {self.theme['name']}
 * Difficulty: {self.difficulty}/5
 */
?>
...
<html>
<head>
    <title>Python Pickle Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def generate_dockerfile(self) -> str:
        """Generate Dockerfile for insecure deserialization vulnerabilities"""
