"""
SQL Injection Testing Vulnerability Templates
...
class TestingInjectionSqliTemplate(BaseTemplate):
    """
    Template generator for sql injection testing vulnerabilities
    """
    ...
    def generate_code(self) -> str:
        ...
        if variant == "Basic SQL Injection":
            return self._generate_basic_sql_injection()
        else:
            return self._generate_basic_sql_injection()

    def _generate_basic_sql_injection(self) -> str:
        """Generate Basic SQL Injection vulnerable application with themed UI"""
 ...
 * Vulnerability: Basic SQL Injection
...
<html>
<head>
    <title>Basic SQL Injection Challenge</title>
    {fonts_import}
    <style>
{theme_css}
    </style>
...
<body>
    ...
    def generate_dockerfile(self) -> str:
        """Generate Dockerfile for sql injection testing vulnerabilities"""
